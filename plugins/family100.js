...
async function handler(m) {
    ...
    if (id in this.game) {
        this.sendButton(m.chat, 'There are still unanswered quizzes in this chat', '© MilfBOT', 'Surrender', 'nyerah', this.game[id].msg)
        throw false
    }
...
+${winScore} XP every answer is correct
    ...
    this.game[id] = {
        id,
        msg: await this.sendButton(m.chat, caption, '© MilfBOT', 'Surrender', 'nyerah', m),
        ...json,
