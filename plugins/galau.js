let handler = async (m, { conn, usedPrefix, command }) => {
    await conn.sendButton(m.chat, `“${pickRandom(global.galau)}”`, '© MilfBOT', 'Galau', `${usedPrefix + command}`, m)
}
handler.help = ['galau']
handler.tags = ['quotes']
...
global.galau = [
    ...
    "Starting from acquaintances, joking together, ridicule then turned into like, comfortable and finally love and love each other",
    ...
    "Can only be silent and think, why are loyal and good people left behind, the naughty ones are being chased, they are left behind, they say that all men are the same",
    "Even though it's only for a moment you make me happy, but the happiness that he doesn't quickly forget",
    ...
    "I can't wait forever and now Iu become doubtful do you still love me",
    "Don't make me hopeful if you don't want me",
    "Better alone than together but without certainty",
    "Leaving doesn't mean you stop loving but disappointed and tired of having to fight alone",
    "It's not that I don't want to be your girlfriend I just want to be together the right way",
    ...
    "Thanks to you I've become forgetful about my past",
    "Beautiful love stories without problems are only in the fairy tale world",
